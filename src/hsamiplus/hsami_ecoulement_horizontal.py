...
def hsami_ecoulement_horizontal(nb_pas,vidange_reserve_inter,reserve_inter,eau_hydrogrammes,
                                hydrogrammes,apport_vertical,modules):
    '''
     ENTRÉES
     -------
     nb_pas                : Voir hsami2_noyau (projet['nb_pas_par_jour'])
     vidange_reserve_inter : Voir hsami2_noyau (projet['param(19)']) 
     reserve_inter         : Voir hsami2_noyau (etat['reserve'])
     eau_hydrogrammes      : Voir hsami2_noyau (etat['eau_hydrogrammes'])
     hydrogrammes          : Hydrogrammes unitaires de surface et 
                             intermediaire
     ...
     SORTIES
     -------
     apport                : Apports verticaux laminés
     reserve_inter         : Voir hsami2_noyau (etat['reserve'])
     eau_hydrogrammes      : Voir hsami2_noyau (etat['eau_hydrogrammes'])

     EXEMPLE
     -------
     Pas de temps 120 de projet_test.json, tous les modules sont aux valeurs
     PAR DÉFAUT
    ...
    apport = [apport_vertical[0], reserve_inter, eau_hydrogrammes[0,0], apport_vertical[3], 
              apport_vertical[4], eau_hydrogrammes[0,2]]
